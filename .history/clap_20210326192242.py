...
def clap_html():
    ...
    username_list = ['championfsd@protonmail.com', 'bgfnggh@protonmail.com', 'gdsdggfsd@protonmail.com']
    password_list = ['yuig4796', 'yuig4796', 'yuig4796s']
    ...
    for username, password in zip(username_list, password_list):
        ...
        for i in range(8):
            js = 'window.open("https://likecoin-2.github.io/total{}");'.format(i)
